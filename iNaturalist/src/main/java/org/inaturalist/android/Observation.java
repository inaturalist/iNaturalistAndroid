...
public class Observation implements BaseColumns, Serializable {
    ...
    public static final String DEFAULT_SORT_ORDER = "CASE WHEN id IS NULL THEN _created_at ELSE created_at END DESC, CASE WHEN id IS NULL THEN _id ELSE id END DESC";

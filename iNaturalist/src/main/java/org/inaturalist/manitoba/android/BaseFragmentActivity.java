...
public class BaseFragmentActivity extends SherlockFragmentActivity {
	...
	private void buildSideMenu() {
        ...
        map.put("title", getString(R.string.home));
        map.put("description", getString(R.string.home));
        MENU_ITEMS.add(map);
        ...
        map = new HashMap<String,String>();
        map.put("title", getString(R.string.about));
        map.put("description", getString(R.string.about_text));
        MENU_ITEMS.add(map);
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
        	...
        	public void onItemClick(AdapterView parent, View view, int position, long id) {
                ...
                if (title.equals(getString(R.string.home))) {
                    startActivityIfNew(new Intent(BaseFragmentActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));

...
//		            "org.inaturalist.manitoba.android",
	   ...
	   makeLanguageRadioButtons(); 
        ...
        mGoogleLogin.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                signIn(INaturalistService.LoginType.GOOGLE, null, null);
            }
        });
...
//                        Log.d(TAG, "FB Login: " + accessToken);
                        new SignInTask(INaturalistPrefsActivity.this).execute(null, accessToken, INaturalistService.LoginType.FACEBOOK.toString());
                    }
                }
            }
        });
        ...
        mSignInButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				signIn(INaturalistService.LoginType.PASSWORD, username, password);
			}
		});
...
//	                        Log.d(TAG, String.format("Token: %s", authToken));
	                        new SignInTask(INaturalistPrefsActivity.this).execute(boundUsername, authToken, INaturalistService.LoginType.GOOGLE.toString(), boundInvalidated);
	        ...
	        // "Regular" login
	        new SignInTask(this).execute(username, password, INaturalistService.LoginType.PASSWORD.toString());
	    }
	}

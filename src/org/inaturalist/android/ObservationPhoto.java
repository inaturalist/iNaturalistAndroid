// BEGIN GENERATED BY /Users/kueda/projects/eclipse/workspace/iNaturalist/rails2android.rb AT Mon Dec 26 16:29:24 -0500 2011
...
public class ObservationPhoto implements BaseColumns, Serializable {
    ...
    public boolean isDirty() {
        ...
        if (_observation_id_changed()) {
            Log.d(TAG, "_observation_id: " + _observation_id + ", _observation_id_was: " + _observation_id_was);
            return true;
        }
        if (_photo_id_changed()) {
            Log.d(TAG, "_photo_id: " + _photo_id + ", _photo_id_was: " + _photo_id_was);
            return true;
        }
        ...
        if (observation_id_changed()) {
            Log.d(TAG, "observation_id: " + observation_id + ", observation_id_was: " + observation_id_was);
            return true;
        }
        if (photo_id_changed()) {
            Log.d(TAG, "photo_id: " + photo_id + ", photo_id_was: " + photo_id_was);
            return true;
        }
        if (position_changed()) {
            Log.d(TAG, "position: " + position + ", position_was: " + position_was);
            return true;
        }
...
// END GENERATED BY /Users/kueda/projects/eclipse/workspace/iNaturalist/rails2android.rb AT Mon Dec 26 16:29:24 -0500 2011

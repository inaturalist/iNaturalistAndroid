// BEGIN GENERATED BY /Users/kueda/projects/eclipse/workspace/iNaturalist/rails2android.rb AT Thu Dec 08 22:13:33 -0800 2011
...
public class ObservationPhoto implements BaseColumns, Serializable {
    ...
    public void merge(ObservationPhoto observation_photo) {
        if (this._updated_at.before(observation_photo.updated_at)) {
            // overwrite
            this._created_at = observation_photo._created_at;
            this._observation_id = observation_photo._observation_id;
            this._photo_id = observation_photo._photo_id;
            this._updated_at = observation_photo._updated_at;
            ...
            // set if null
            if (this._created_at == null) { this._created_at = observation_photo._created_at; }
            if (this._observation_id == null) { this._observation_id = observation_photo._observation_id; }
            if (this._photo_id == null) { this._photo_id = observation_photo._photo_id; }
            if (this._updated_at == null) { this._updated_at = observation_photo._updated_at; }
    ...
    public ArrayList<NameValuePair> getParams() {
        ...
        if (_observation_id != null) { params.add(new BasicNameValuePair("observation_photo[_observation_id]", _observation_id.toString())); }
        if (_photo_id != null) { params.add(new BasicNameValuePair("observation_photo[_photo_id]", _photo_id.toString())); }
...
// END GENERATED BY /Users/kueda/projects/eclipse/workspace/iNaturalist/rails2android.rb AT Thu Dec 08 22:13:33 -0800 2011

// BEGIN GENERATED BY /Users/kueda/projects/eclipse/workspace/iNaturalist/rails2android.rb AT Mon Dec 26 16:29:06 -0500 2011
...
public class Observation implements BaseColumns, Serializable {
    ...
    public boolean isDirty() {
        ...
        if (positioning_device_changed()) {
            Log.d(TAG, "positioning_device: " + positioning_device + ", positioning_device_was: " + positioning_device_was);
            return true;
        }
        if (positioning_method_changed()) {
            Log.d(TAG, "positioning_method: " + positioning_method + ", positioning_method_was: " + positioning_method_was);
            return true;
        }
        ...
        if (user_agent_changed()) {
            Log.d(TAG, "user_agent: " + user_agent + ", user_agent_was: " + user_agent_was);
            return true;
        }
        if (user_id_changed()) {
...
// END GENERATED BY /Users/kueda/projects/eclipse/workspace/iNaturalist/rails2android.rb AT Mon Dec 26 16:29:06 -0500 2011

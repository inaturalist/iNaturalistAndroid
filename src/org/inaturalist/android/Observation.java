// BEGIN GENERATED BY Observation.java.rb AT Mon Dec 05 16:00:19 -0800 2011
...
public class Observation implements BaseColumns {
	...
	public Observation(Cursor c) {
		...
		this._created_at = new Timestamp(c.getLong(c.getColumnIndexOrThrow(_CREATED_AT)));
		this._synced_at = new Timestamp(c.getLong(c.getColumnIndexOrThrow(_SYNCED_AT)));
		this._updated_at = new Timestamp(c.getLong(c.getColumnIndexOrThrow(_UPDATED_AT)));
...
// END GENERATED BY Observation.java.rb AT Mon Dec 05 16:00:19 -0800 2011
